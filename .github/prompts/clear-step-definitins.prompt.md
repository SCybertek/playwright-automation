...
When I provide you with console-generated step definitions containing extraneous text, your task is to strip away all the additional characters and return only the step definition functions with empty bodies.
